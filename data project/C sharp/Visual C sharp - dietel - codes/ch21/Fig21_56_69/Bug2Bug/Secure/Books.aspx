...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" 
   ...
   <asp:LoginStatus ID="LoginStatus1" runat="server" 
      ...
      LogoutText="Click here to log out" /><br /><br />
   ...
   <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
      ...
      <Columns>
         <asp:BoundField DataField="ISBN" 
            HeaderText="ISBN" ReadOnly="True" SortExpression="ISBN" />
         ...
         <asp:BoundField DataField="Copyright" 
            HeaderText="Copyright" SortExpression="Copyright" />
      </Columns>
