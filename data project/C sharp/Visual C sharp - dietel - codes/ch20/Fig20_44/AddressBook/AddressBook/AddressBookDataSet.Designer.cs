...
namespace AddressBook {
    ...
    [System.Xml.Serialization.XmlRootAttribute("AddressBookDataSet")]
    [System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class AddressBookDataSet : System.Data.DataSet {
        ...
        [System.Diagnostics.DebuggerNonUserCodeAttribute()]
        protected AddressBookDataSet(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : 
...
namespace AddressBook.AddressBookDataSetTableAdapters {
...
SELECT AddressID, FirstName, LastName, Email, PhoneNumber FROM Addresses WHERE (AddressID = @AddressID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new System.Data.SqlClient.SqlParameter("@AddressID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, 0, 0, "AddressID", System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        
        [System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private void InitConnection() {
            this._connection = new System.Data.SqlClient.SqlConnection();
            this._connection.ConnectionString = global::AddressBook.Properties.Settings.Default.AddressBookConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT AddressID, FirstName, LastName, Email, PhoneNumber FROM dbo.Addresses WHER" +
                "E LastName = @lastName";
            this._commandCollection[1].CommandType = System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new System.Data.SqlClient.SqlParameter("@lastName", System.Data.SqlDbType.VarChar, 30, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByLastName(AddressBookDataSet.AddressesDataTable dataTable, string lastName) {
        ...
        public virtual AddressBookDataSet.AddressesDataTable GetDataByLastName(string lastName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((lastName == null)) {
                throw new System.ArgumentNullException("lastName");
            }
        ...
        public virtual int Delete(int Original_AddressID, string Original_FirstName, string Original_LastName, string Original_Email, string Original_PhoneNumber) {
            ...
            if ((Original_PhoneNumber == null)) {
                throw new System.ArgumentNullException("Original_PhoneNumber");
            }
            else {
